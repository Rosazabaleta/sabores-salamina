        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-white rounded-xl overflow-hidden tonal-shadow border border-[#e4e2de]">
          ...
          <div className="relative hidden lg:block overflow-hidden min-h-[600px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#154212]/80 to-transparent flex flex-col justify-end p-10">
              <h1 className="text-display-lg text-white mb-2">Bienvenido a nuestra mesa</h1>
              <p className="text-white/90 text-body-lg">
                Unete a la comunidad de Sabores de Salamina y descubre la herencia culinaria de nuestro pueblo.
              </p>
            </div>
          </div>
          ...
          <div className="p-10 md:p-16 flex flex-col justify-center">
            <div className="mb-10">
              <h2 className="text-headline-md text-[#154212] mb-1">Crear una Cuenta</h2>
              <p className="text-[#42493e]">Registrate para gestionar tus pedidos y reservas.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1">
                  <label className="text-label-md text-[#1b1c1a]">Nombre Completo</label>
                  <Input
                    type="text"
                ...
                <div className="space-y-1">
                  <label className="text-label-md text-[#1b1c1a]">Telefono</label>
                  <Input
                    type="tel"
                    placeholder="+57 300..."
                    value={phone}
              ...
              <div className="space-y-1">
                <label className="text-label-md text-[#1b1c1a]">Direccion en Salamina</label>
                <Input
                  type="text"
                  placeholder="Calle Real No. 12-34"
                  value={address}
            ...
            <div className="mt-16 text-center">
              <p className="text-[#42493e] text-body-md">Ya tienes una cuenta?</p>
              <Link 
                href="/auth/login" 
